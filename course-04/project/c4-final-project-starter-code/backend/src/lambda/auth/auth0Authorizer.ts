...
const jwksUrl = 'https://hellotunmbi.auth0.com/.well-known/jwks.json'
...
async function verifyToken(authHeader: string): Promise<JwtPayload> {
  try {
    ...
    const oAuthResponse: any = await Axios.get(jwksUrl)
    const oAuthCert: any = oAuthResponse['data']['keys'][0]['x5c'][0]
